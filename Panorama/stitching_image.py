# -*- coding: utf-8 -*-
"""
Created on Thu Sep  6 15:11:02 2018
...
def get_stitched_image(img1, img2, M):
    ...
    #img2_dims_temp = np.array([img2_dims_temp])    
...
def get_sift_homography(img1, img2):
    ...
    # 特徴検出
    k1,d1 = detector.detect(img1)
    k2,d2 = detector.detect(img2)
    """
...
def main():
    ...
    img1 = cv2.imread("../scene/res3/resize0.jpg")
    img2 = cv2.imread("../scene/res3/resize1.jpg")
    M =  get_sift_homography(img1, img2)
    result_image = get_stitched_image(img2, img1, M)
    cv2.imshow ('Result', result_image)
    cv2.imwrite("../this34.jpg",result_image)
    cv2.waitKey()
